        ...
        <div className="min-h-screen bg-base-100">
            ...
            <div className="container mx-auto py-8 px-4 md:px-6">
                <div className="prose max-w-4xl mx-auto">
                    ...
                    <p>
                        Our Service allows you to post, store, share and otherwise make available certain information, text, graphics, or other material ("Content"). You are responsible for the Content that you post on or through the Service, including its legality, reliability, and appropriateness.
                    </p>
                    <p>
                    ...
                    <h2 className="text-xl font-bold mt-8 mb-4">4. Termination</h2>
                    <p>
                    ...
                    <p>
                        These Terms shall be governed and construed in accordance with the laws of Imus City, Cavite, without regard to its conflict of law provisions.
                    </p>
                    <p>
